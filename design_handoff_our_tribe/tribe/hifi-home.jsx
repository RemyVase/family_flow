...
const TASKS0 = [
  { id: 't1', s: 'am', name: 'Vider le lave-vaisselle', time: '8:00',  rep: 'tous les jours', pts: 2, done: true  },
  { id: 't2', s: 'am', name: 'Donner à manger au chat',  time: '8:30', rep: '2×/jour',        pts: 1, done: true  },
  { id: 't3', s: 'am', name: 'Préparer le sac de sport', time: '8:45', pts: 1, done: false },
  { id: 't4', s: 'pm', name: 'Sortir les poubelles',     time: '17:00', rep: '1×/semaine',    pts: 3, done: false },
  { id: 't5', s: 'pm', name: 'Devoirs de maths',         time: '18:00', pts: 2, photo: true, done: false },
  { id: 't6', s: 'ev', name: 'Mettre la table',          time: '19:00', rep: '3×/jour',       pts: 1, done: false },
  { id: 't7', s: 'ev', name: 'Ranger le salon',          time: '20:00', pts: 2, done: false },
];
...
function Home({ tw, onNav, tasks, onToggle, onOpen, onProfile, cvars }) {
      ...
      <div className="scroll">
        ...
        <div className="hdr">
          ...
          <div className="hdr-right">
            <button className="hdr-ava" onClick={onProfile} aria-label="Profil">L</button>
            <div className="iconbtn"><span className="dot" />{HIcon.bell}</div>
        ...
        {/* sections */}
        {SECTIONS.map((sec) => {
          const items = tasks.filter((t) => t.s === sec.key);
